...
publishing {
    publications {
        register<MavenPublication>("release") {
            ...
            pom {
                name = "Keep KSP Compiler"
                description = "A KSP compiler that generates obfuscation rules from annotated declarations"
