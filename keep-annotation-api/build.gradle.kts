...
android {
    ...
    compileSdk = 34
    namespace = "dev.g000sha256.keep.annotation.api"
    ...
    publications {
        afterEvaluate {
            register<MavenPublication>("release") {
                ...
                pom {
                    name = "Keep Annotation API"
                    description = "The annotation and the R8 rules for keeping API declarations in library modules"
